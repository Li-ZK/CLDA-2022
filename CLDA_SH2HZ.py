...
def clean_sampling_epoch(labels, probabilities):
    ...
    label_error_indices = cleanlab.latent_estimation.compute_confident_joint(
        labels, probabilities, return_indices_of_off_diagonals=True)[1]
...
for iDataSet in range(nDataSet):
    ...
    if args.cuda:
        ...
        F2.cuda()
    # optimizer and losss
    optimizer_g = optim.SGD(G.parameters(), lr=args.lr / 10,weight_decay=0.0005)
...
# utils.classification_map(hsi_pic[0, 0, :], best_G[0, 0], 24, "./classificationMap/HZ.png")
